...
vim.keymap.set({ "x" }, "q", "sa`", { desc = "Put backticks around visual selection", remap = true })
...
local opts = {win={style="split", height=20}}

vim.keymap.set("n", "<leader>rr", function()
  Snacks.terminal(utils.get_python_tool() .. " run ruff check", opts)
  vim.cmd("wincmd p")
end, { desc = "Run ruff check" })
vim.keymap.set("n", "<leader>rR", function()
  Snacks.terminal(utils.get_python_tool() .. " run ruff check --fix", opts)
  vim.cmd("wincmd p")
end, { desc = "Run ruff check --fix" })
vim.keymap.set("n", "<leader>rb", function()
  Snacks.terminal(utils.get_python_tool() .. " run black .", opts)
  vim.cmd("wincmd p")
end, { desc = "Run ruff check --fix" })
vim.keymap.set("n", "<leader>rm", function()
  Snacks.terminal(utils.get_python_tool() .. " run mypy", opts)
  vim.cmd("wincmd p")
end, { desc = "Run mypy" })
vim.keymap.set("n", "<leader>rt", function()
  Snacks.terminal(utils.get_python_tool() .. " run pytest", opts)
  vim.cmd("wincmd p")
end, { desc = "Run pytest" })
vim.keymap.set("n", "<leader>rp", function()
  Snacks.terminal(utils.get_python_tool() .. " run pre-commit run", opts)
  vim.cmd("wincmd p")
end, { desc = "Run pre-commmit" })
